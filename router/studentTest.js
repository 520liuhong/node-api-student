...
const {callBackSuc} = require('../utils/utils.js')
const userSQL = require('../db/studentSql')
/**
 * 查询所有
 */
router.get('/queryAll', (req, res) => {
    console.log('打印查询条件', req)
    console.log('打印查询', res)
    let _res = res;
    let _data;
    // 从连接池获取连接
...
router.post('/register', (req, res) => {
    // 获取前台页面传过来的参数
    let user = {
        username: req.body.username, realname: req.body.realname, password: req.body.password
    }
    let _res = res;
